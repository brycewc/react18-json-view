...
type Theme = 'default' | 'a11y' | 'github' | 'vscode' | 'vscode-modern' | 'vscode-2026' | 'atom' | 'winter-is-coming' | 'vitesse'

const themes: Theme[] = ['default', 'a11y', 'github', 'vscode', 'vscode-modern', 'vscode-2026', 'atom', 'winter-is-coming', 'vitesse']
